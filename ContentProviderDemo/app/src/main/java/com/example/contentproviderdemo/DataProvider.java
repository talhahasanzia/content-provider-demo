...
import static com.example.contentproviderdemo.DataContract.AGE;
import static com.example.contentproviderdemo.DataContract.CONTENT_AUTHORITY;
import static com.example.contentproviderdemo.DataContract.NAME;
import static com.example.contentproviderdemo.DataContract.PATH_INFO;
...
public class DataProvider extends ContentProvider
{
	...
	public String getType( Uri uri )
	{
		...
		switch ( uriMatcher.match( uri ) )
		{
			...
			case NAME:
				return "com.example.contentproviderdemo/personal_info?name";
			
			case AGE:
				return "com.example.contentproviderdemo/personal_info?age";
			default:
